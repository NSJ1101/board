...
<%
String gener_code = request.getParameter("gener_code");
String query="select id,post_number,decode(gener_code,1,'자유 게시판',2,'유머 게시판') ,post_title,post_content,to_char(post_date,'yyyy-mm-dd') from post_tbl "+ 
" where gener_code ='"+gener_code+"' "+
...
<button value="글쓰기" onclick="location.href='post_add.jsp'" class="btn btn-secondary" style="float:right;">글쓰기</button>
</section>
</body>
</html>